...
([Task](https://mlr3.mlr-org.com/dev/reference/Task.md)), learners
...
- design:
  ...
  [Learner](https://mlr3.mlr-org.com/dev/reference/Learner.md) and an
  instantiated
  [Resampling](https://mlr3.mlr-org.com/dev/reference/Resampling.md)
  ...
  per [Task](https://mlr3.mlr-org.com/dev/reference/Task.md).
  Additionally, you can set the additional column 'param_values', see
  [`benchmark_grid()`](https://mlr3.mlr-org.com/dev/reference/benchmark_grid.md).
...
[`Resampling`](https://mlr3.mlr-org.com/dev/reference/Resampling.md)s
are instantiated on the task, making the function stochastic even in
case of deterministic learners.
...
#>                                   uhash                   task
#>                                  <char>                 <list>
#> 1: 6945ea4a-07cd-40fd-9bdc-03a181d4d737 <TaskClassif:penguins>
#> 2: 6945ea4a-07cd-40fd-9bdc-03a181d4d737 <TaskClassif:penguins>
#> 3: 6945ea4a-07cd-40fd-9bdc-03a181d4d737 <TaskClassif:penguins>
#> 4: c3aa014b-324c-4b41-97d5-b38709346713 <TaskClassif:penguins>
#> 5: c3aa014b-324c-4b41-97d5-b38709346713 <TaskClassif:penguins>
#> 6: c3aa014b-324c-4b41-97d5-b38709346713 <TaskClassif:penguins>
